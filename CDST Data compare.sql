...
SELECT
    ...
    coupon_diff
FROM COMPARISON
WHERE business_date = '2026-02-11'

    /* All 4 must be NULL */
    AND old_lead_manager IS NULL
    AND new_lead_manager IS NULL
    AND old_deal_sponsor IS NULL
    AND new_deal_sponsor IS NULL

    /* Optional: only changed coupon */
    AND (
